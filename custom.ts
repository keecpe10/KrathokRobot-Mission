...
namespace KrathokRobot {
    ...
    /**ตั้งค่าเริ่มต้นการใช้งาน 
      */
    //% blockId="LineRobot_ตั้งค่าเริ่มต้น" block="ตั้งค่าตั้งค่าเริ่มต้น"
    //% weight=100
    export function init_start(): void {
    ...
    /**ตั้งค่าเริ่มต้น จำนวนเซนเซอร์  
      ...
      */
    //% blockId="LineRobot_ตั้งค่า" block="ตั้งค่า | จำนวนเซ็นเซอร์ %NSensors"
    //% NSensors.min=1 NSensors.max=8
    //% weight=100
    export function ตั้งค่า(NSensors: number): void {
        numSensors = NSensors
        for (let n = 0; n < numSensors; n++) {
            valSensorsMin[n] = 4095
            valSensorsMax[n] = 0
    ...
    //% NSensors.min=1 NSensors.max=8
    //% weight=100
    export function ตั้งค่าความเร็วเข้าเส้น(speed_turn: number): void {
    ...
    /**เลี้ยว
      ...
      */
    //% help=math/map weight=10 blockGap=8
    //% blockId=LineRobot_หมุน_spin block="หมุนทาง %LineRobotTurnDirec| ด้วยความเร็ว %speed"
    //% speed.min=0 speed.max=800
    //% inlineInputMode=inline
    export function หมุน(direc: LineRobotTurnDirec, speed: number): void {
    ...
    //% speed.min=0 speed.max=800
    //% inlineInputMode=inline
    export function วิ่งตามเส้นจับเวลา(speed: number, time: number, kp: number, kd: number): void {
        let previousMillis = input.runningTime()
     ...
     */
    //% blockId="LineRobot_Servo" block="หมุนเซอร์โว %LineRobotServo| %Degree องศา"
    //% Degree.min=0 Degree.max=180
    //% weight=75
    export function Servo(Servo: LineRobotServo, Degree: number): void {
